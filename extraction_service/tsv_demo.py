...
def prepare_tsv_path(img_list, tsv_path):
    """
    img_dict: list of dicts {'id', 'base64', 'width', 'height'}
    """

    dataset_path = tsv_path #"/home/nicola/scene_graph_test_dataset"
    ...
    for img_p in tqdm.tqdm(img_list):
        img_key = img_p['id'].split('.')[0]
        # img_path = op.join(data_path, img_p)
        img_encoded_str = img_p['base64']
